...
> [!WARNING]
> This project is **working in progress** <i>(nearly dumped and forgotten lmao).</i><br>
...
## <center> Features as of now. </center>
-  <strong>User authentication</strong>: Cookie based JWT token authentication system.
