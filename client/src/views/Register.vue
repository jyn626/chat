<template>
  <div class="bg-white w-[422px]  min:h-[400px]  border  border-slate-400 shadow-md">
    ...
    <form v-motion-fade class="" @submit.prevent="register">
      ...
      <div class="mt-2 px-4 flex flex-col">
        ...
        <label>
          confirm password
          <input type="password" placeholder="Make sure it's secure" v-model="passwordConfirmation"
            name="passwordConfirmation" class="border border-gray-400 px-4 py-1.5 w-full shadow-inner outline-none" />
        </label>
